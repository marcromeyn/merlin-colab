...
class MovieLensData(object):
    ...
    def transform(self, output_path, workflow: nvt.Workflow,  part_size="100MB",  shuffle=nvt.io.Shuffle.PER_PARTITION,
                  **kwargs):
...
# load(output_dir) -> train, eval, movies
